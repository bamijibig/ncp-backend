    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('eval_nameofextss', models.CharField(choices=[('existing substation bf relief', 'existing substation bf relief'), ('existing substation after relieve', 'existing substation after relieve')], default='name of ss', max_length=100)),
